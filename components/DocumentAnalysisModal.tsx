...
import { Loader2, FileText, X, Gavel, Calendar, User, Hash, BrainCircuit, Bookmark, BookmarkCheck, HelpCircle, Scale } from 'lucide-react';
...
const getEntityIcon = (type: string) => {
  switch (type) {
    case 'judge': return <Gavel className="w-5 h-5 mr-3 text-[#b5892f]" />;
    case 'party': return <User className="w-5 h-5 mr-3 text-[#e2c07d]" />;
    case 'date': return <Calendar className="w-5 h-5 mr-3 text-[#6e501a]" />;
    case 'case_number': return <Hash className="w-5 h-5 mr-3 text-[#b5892f]" />;
    default: return <FileText className="w-5 h-5 mr-3 text-[#6e501a]" />;
  }
}
            ...
            <div className="bg-[#121212] border border-[#6e501a] shadow-[0_60px_150px_rgba(0,0,0,1)] max-w-4xl w-full max-h-[92vh] overflow-y-auto relative custom-scrollbar">
                ...
                <div className="flex justify-between items-center p-8 border-b border-[#6e501a]/20">
                    <h2 className="text-2xl font-black text-[#efefef] uppercase tracking-[0.3em] italic flex items-center">
                        <FileText className="w-8 h-8 mr-6 text-[#b5892f]" />
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <button onClick={onClose} className="text-[#6e501a] hover:text-[#efefef] transition-colors"><X className="w-8 h-8" /></button>
                    </div>
                </div>
                    ...
                    {!result && !isLoading ? (
                        <div className="space-y-12">
                            ...
                            >
                                ...
                                <FileText className="w-20 h-20 text-[#6e501a] mb-8" />
                        ...
                        <div className="py-40 flex flex-col items-center justify-center space-y-10">
                             <Loader2 className="w-20 h-20 text-[#b5892f] animate-spin" />
                        ...
                        <div className="space-y-16 animate-[fadeIn_0.5s_ease-out]">
                                ...
                                {onMapNarrative && (
                                    ...
                                    >
                                        <div className="relative">
                                          <BrainCircuit className="w-16 h-16 text-[#b5892f] group-hover:scale-110 transition-transform" />
                            ...
                            <div className="mt-12 pt-12 border-t border-[#6e501a]/20">
                                <h4 className="text-xs font-black text-[#b5892f] uppercase tracking-[0.5em] mb-8 flex items-center gap-4">
                                    <HelpCircle className="w-5 h-5" /> [NEURAL_QUERY_CHANNEL]
                                </h4>
                                    ...
                                    {isAsking && (
                                        <div className="flex justify-start">
                                            <div className="bg-[#121212] border border-[#6e501a]/40 p-6 flex items-center gap-4">
                                                <Loader2 className="w-4 h-4 text-[#b5892f] animate-spin" />
