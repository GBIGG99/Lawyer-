...
import { Gavel, Sparkles, BrainCircuit } from 'lucide-react';
...
const ANALYSIS_PROMPTS = [
    { id: 'tendencies', text: 'Judge Tendencies', icon: Gavel },
    { id: 'loopholes', text: 'Procedural Loops', icon: Sparkles },
    { id: 'strategy', text: 'Legal Strategy', icon: BrainCircuit },
];
